...
const Story = () => {
  ...
  return (
    <div
      dir="rtl"
      className="hidden lg:flex select-none w-full lg:h-[173px] flex flex-row flex-wrap justify-center pt-7 overflow-hidden lg:overflow-visible"
    >
      <div className="w-[95%] h-[150px] flex flex-row flex-nowrap items-center gap-6">
        <Swiper
          dir="rtl"
          modules={[Navigation]}
          spaceBetween={30}
